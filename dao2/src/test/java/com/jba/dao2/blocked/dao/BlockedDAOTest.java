...
public class BlockedDAOTest {
    ...
    public void addNewBlockStatus() {
        ...
        blockedDAO.deleteBlockStatus(BlockStatus.of(blockStatus.getBlockStatusId()));
    }

    @Test
    public void blockUser() {
        BlockedUsers blockedUsers = blockedDAO.blockUser(User.of(2), User.of(1), BlockStatus.of(1),"Just because!!!!");

        assertNotNull("Blocked user should not be null",blockedUsers);

        blockedDAO.unlockUser(User.of(2), false);
    }
    ...
    public void unlockUser() {
        ...
        blockedDAO.unlockUser(user, false);
        ...
        try{
            ...
            blockedDAO.unlockUser(user, true);
        }
    }
}